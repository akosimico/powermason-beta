...
MIDDLEWARE = [
    ...
    "authentication.middleware.ForcePasswordChangeMiddleware",  # Must be after AuthenticationMiddleware
...
if ENVIRONMENT == "production":
    SITE_URL = os.getenv("SITE_URL", "https://powermason-beta.onrender.com")
else:
...
ACCOUNT_EMAIL_VERIFICATION = "mandatory"  # Send verification email (was "none")
