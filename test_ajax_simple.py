...
def test_ajax_simple(request):
    """Simple test view for AJAX navigation components without API calls"""
    html_content = """
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>AJAX Navigation Test - Simple</title>
    ...
    <script src="/static/js/projects-module.js"></script>
...
<body class="bg-gray-100 p-8">
    <div class="max-w-4xl mx-auto">
        <h1 class="text-3xl font-bold text-gray-900 mb-8">AJAX Navigation Test - Simple</h1>
        ...
        <div class="bg-white rounded-lg shadow-lg p-6 mb-6">
            ...
            <div id="test-results" class="space-y-2">
                ...
                <div class="flex items-center space-x-2">
                    <div id="projects-test" class="w-4 h-4 bg-gray-300 rounded-full"></div>
        ...
        <div class="bg-white rounded-lg shadow-lg p-6 mt-6">
            <h2 class="text-xl font-semibold mb-4">Test Notes</h2>
            <div class="space-y-2 text-sm text-gray-600">
                <p>• This test only checks if JavaScript modules load correctly</p>
                <p>• API endpoints are not tested (they may not exist yet)</p>
                <p>• Chart.js errors are expected if dashboard elements are missing</p>
                <p>• Focus on whether the modules themselves load without syntax errors</p>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function runTests() {
            ...
            if (typeof window.initializeProjects === 'function') {
                ...
                document.getElementById('projects-test').className = 'w-4 h-4 bg-green-500 rounded-full';
                log('✅ Projects module loaded');
            } else {
                document.getElementById('projects-test').className = 'w-4 h-4 bg-red-500 rounded-full';
                log('❌ Projects module not found');
            }
